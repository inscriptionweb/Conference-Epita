...
\item they save what websites are you're visiting, what do you like or dislike
and what you buy.
...
\item In fact every ad and many widget do it.
}
\end{itemize}
\end{block}
}
...
Possibility to setup a whitelist if you really want to keep some cookies for some
...
\column{.5\linewidth}
\justifying{
Made by the electronic frontier fondation (EFF), it forces the HTTPS when
...
\\
Also, activate the SSL Observatory : it prevents from MITM attacks and more
